...
async function runIntegrationTests() {
    ...
    try {
        ...
        const signupResponse = await apiCall('POST', '/organizations/signup', {
            name: 'DR RS Central Public School',
            email: 'drrscentral@test.com',
            mobile: '9876543219',
            address: 'Jahangira, Khagaria, Bihar',
            firstName: 'Dr Rohit',
            lastName: 'Sharma',
            adminEmail: 'drrscentral-admin@test.com',
        ...
        const loginResponse = await apiCall('POST', '/organization-users/login', {
            email: 'drrscentral-admin@test.com',
        ...
        for(let i = 1; i < 11; i++) {
            ...
            if (createClassResponse.data.success) {
                console.log(`  Created Class ID: ${createClassResponse.data.data._id}`);
            }
        ...
        const admitStudentResponse = await apiCall('POST', '/students/admit', {
            fullName: 'Hammad Fasih',
            age: 16,
            bloodGroup: 'O+',
            mobile: '9876543220',
            parentMobile: '9876543221',
            studentEmail: 'hammad@test.com',
            parentEmail: 'hammad@test.com',
